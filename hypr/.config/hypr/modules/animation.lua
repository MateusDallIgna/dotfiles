...
hl.animation({ leaf = "windowsOut", enabled = true, speed = 4, bezier = "snappyReturn", style = "slide" })
hl.animation({ leaf = "windowsMove", enabled = true, speed = 4, bezier = "wind", style = "slide" })
hl.animation({ leaf = "layers", enabled = true, speed = 4, bezier = "bounce", style = "popin 50%" })
hl.animation({ leaf = "layersOut", enabled = true, speed = 5, bezier = "bounce", style = "fade" })
